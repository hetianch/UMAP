function out = extract_plot_diagnosis_candidates( scores_fromJAABA,diagnosiscandidate,trx,fly_to_plot_array,true_number,goodtrx)
...
%size(frame_to_plot_JAABA')
%size(JAABA_pred')
%size(NAFF_pred')
%size(frame_to_plot_true')
%size(true_to_plot)

wholematrix=[frame_to_plot_JAABA',JAABA_pred',NAFF_pred']
%size(wholematrix);
disagreematrix=[frame_to_plot_true',true_to_plot];
name1=strcat('plot_whole',num2str(fly_to_plot),'.csv');
name2=strcat('plot_disagree',num2str(fly_to_plot),'.csv');
