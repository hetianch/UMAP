...
data = numpy.loadtxt("/Users/071cht/Desktop/programming_language_tutorial/Python/scikit/Ye_thesis/data_scikit/real_data/chase_110window.txt",delimiter=',') 
labels = numpy.loadtxt("/Users/071cht/Desktop/programming_language_tutorial/Python/scikit/Ye_thesis/data_scikit/real_data/label.txt")
# check dataset
#print data,labels
...
params = {'kernel': 'rbf', 'probability': 1}
svc = SVC(**params)
...
plt.ylabel('True')
plt.title ('confusion matrix for svm_linear before rescale')
